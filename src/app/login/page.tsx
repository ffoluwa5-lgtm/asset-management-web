      ...
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @media (max-width: 768px) {
          ...
          .brand-panel .brand-headline { display: none; }
          .brand-panel .brand-desc { display: none; }
          .brand-panel .brand-badges { display: none; }
          .brand-panel .brand-stats { display: none; }
          .form-panel {
      ...
      <div className="login-wrapper">
        ...
        <div className="brand-panel">
          ...
          <div style={{ position: "relative", display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <div>
              <div style={{ color: "#fff", fontWeight: 700, fontSize: 18, letterSpacing: "-0.3px" }}>AssetFlow</div>
              <div style={{ color: "#3d4251", fontSize: 11, fontWeight: 500 }}>Financial Institution</div>
            </div>
          </div>

          {/* Headline — hidden on mobile */}
          <div className="brand-headline" style={{ position: "relative" }}>
            <div style={{
              ...
              <span style={{ color: "#4f7fff", fontSize: 11, fontWeight: 600, letterSpacing: "0.06em" }}>ENTERPRISE PLATFORM</span>
            </div>
            <h1 style={{
            ...
            <p className="brand-desc" style={{ color: "#5a6278", fontSize: 15, lineHeight: 1.7, maxWidth: 340 }}>
              Track every asset across your institution — from registration to retirement.
            </p>
            <div className="brand-stats" style={{ display: "flex", gap: 32, marginTop: 36 }}>
              {[{ label: "Assets Tracked", value: "10K+" }, { label: "Uptime", value: "99.9%" }, { label: "Institutions", value: "50+" }].map(s => (
                <div key={s.label}>
          ...
          <div className="brand-badges" style={{ position: "relative", display: "flex", gap: 20, flexWrap: "wrap" }}>
        ...
        <div className="form-panel">
          <div className="form-inner fade-up" style={{ width: "100%", maxWidth: 400 }}>
            ...
            <div style={{ marginBottom: 16 }}>
              <label style={{ display: "block", color: "#5a6278", fontSize: 11, fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 8 }}>
                Email address
              </label>
              <input
                type="email"
              ...
              <div style={{ position: "relative" }}>
                ...
                <button type="button" onClick={() => setShowPw(s => !s)}
                  style={{
                    ...
                    color: "#3d4251", fontSize: 12, fontWeight: 600, padding: 4,
                  }}>
                  {showPw ? "Hide" : "Show"}
                </button>
              </div>
              ...
              {loading ? (
                <>
                  <div style={{
                    ...
                    border: "2.5px solid #3d4251", borderTopColor: "#5a6278",
